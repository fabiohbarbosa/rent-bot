...
const filters = [
  {
    ...
    url: `https://www.idealista.pt/areas/arrendar-casas/com-preco-max_${maxPrice},moradias,t3,t4-t5/?shape=${shape}`
  },
  {
    enabled: true,
    type: 'apartment',
    logPrefix: '[crawler:idealista:apartment:t3:t4]',
    url: `https://www.idealista.pt/areas/arrendar-casas/com-preco-max_${maxPrice},apartamentos,duplex,t3,t4-t5/?shape=${shape}`
  }
];
